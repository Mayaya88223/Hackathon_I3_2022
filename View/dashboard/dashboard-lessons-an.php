                    ...
                    <div>
                        <div class="d-flex">
                            <div class="niveau-img d-flex f-col">
                                <img src="/Assets/images/deco/fr-chat.svg" alt="">
                            </div>
                            <h3 class="h3--lesson"><a href="#">Leçon 1 </a></h3>
                        </div>
                        <div class="d-flex">
                            <div class="niveau-img d-flex f-col">
                                <img src="/Assets/images/deco/fr-escargot.svg" alt="">
                            </div>
                            <h3 class="h3--lesson"><a href="#">Leçon 2</a></h3>
                        </div>
                        <div class="d-flex">
                            <div class="niveau-img d-flex f-col">
                                <img src="/Assets/images/deco/fr-chouette.svg" alt="">
                            </div>
                            <h3 class="h3--lesson"><a href="#">Leçon 3</a></h3>
                        </div>
